...
my $FHEMVIZ_VERSION = "98_FHEMVIZ.pm:v0.7.2";
...
my @FHEMVIZ_DEV_ATTRS = (
    "vizWidget:switch,sensor,dimmer,actions,text",
...
<ul>
  ...
  <ul>
    <li><b>vizWidget</b> switch|sensor|dimmer|actions|text &ndash; Widget-Typ
